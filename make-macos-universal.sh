...
LDFLAGS=
export SDKROOT=/Library/Developer/CommandLineTools/SDKs/MacOSX10.7.sdk
...
echo Building universal binary, please wait patiently...
...
DMGFILE=${RELEASE_MACOS_DIR}ft2-clone-${VERSION}-macos.dmg
rm -f $DMGFILE
hdiutil create -srcfolder ${APP_DIR} -volname "Fasttracker II clone ${VERSION}" $DMGFILE
